...
duatlon::duatlon(string d, string nc, string nb, int e, int kmsc, int kmsb, bool bm, bool estiu):carrera(d, nc, e, kmsc), ciclisme(d, nb, e, kmsb, bm), fet_a_lestiu(estiu) {}
...
int duatlon::sumar(int n1, int n2)
{
	return n1 + n2;
}
