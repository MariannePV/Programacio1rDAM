...
int main() {
	...
	duatlon d1("1232A", "David", "Marianne", 19, 20, 40, false, true);

	cout << "El nom de l'esportista és " << d1.carrera::get_nom() << endl;
	cout << "El nom de l'esportista és " << d1.ciclisme::get_nom() << endl;
	...
	cout << "Premi " << d1.ciclisme::premi() << endl;
	cout << "Premi " << d1.carrera::premi() << endl;

	cout << "Suma " << duatlon::sumar(2, 3) << endl;
